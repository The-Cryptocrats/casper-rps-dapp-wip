...
import desktopBgImage from "../../../assets/images/casper-click/bg-desktop-full.jpg";
import mobileBgImage from "../../../assets/images/casper-click/bg-mobile-full.jpg";
			...
			<StyledWrapper>
				<InfoContainer>
					<StyledInfo>
						...
						<GreetingText>
							Welcome to Casper Rock, Paper, Scissors (RPS) Dapp Game!
						</GreetingText>
						<KillerAppText>
							Bet and Play RPS To Win CSPR Tokens from Opponents!
						</KillerAppText>
